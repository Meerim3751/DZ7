...
class Gam{
  ...
  get getplay(){
   ...
   get compares(){
    if (this.playerChoice === "камень" && this.computerSelect === "бумага" || this.playerChoice === "бумага" && this.computerSelect === "ножницы" || this.playerChoice === "ножницы" && this.computerSelect === "камень") {
